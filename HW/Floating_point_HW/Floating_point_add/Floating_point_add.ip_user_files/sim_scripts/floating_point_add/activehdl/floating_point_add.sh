...
#
# Script generated by Vivado on Wed Apr 17 20:22:14 +0900 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/OneDrive/Capstone_FPGA_project/Floating_point_add/Floating_point_add.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
